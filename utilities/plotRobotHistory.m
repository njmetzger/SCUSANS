...
switch behavior
    case 'Contour Following'
        ...
        legend_labels{1,(SimParams.NUM_ROBOTS+1)}= 'Desired Contour Value';
        legend_labels{1,(SimParams.NUM_ROBOTS+2)}= 'Buffer Limits';
    ...
    case 'Find Min'
        ...
        legend_labels{1,(SimParams.NUM_ROBOTS+1)}= 'Known Global Minimum';
    ...
    case 'Find Max'
        ...
        legend_labels{1,(SimParams.NUM_ROBOTS+1)}= 'Known Global Maximum';
    ...
    case 'Go To'
        ...
        for i=1:SimParams.NUM_ROBOTS
            ...
            ps(i) = plot(Robot_Data.robot(i).x, Robot_Data.robot(i).y,'LineWidth',2);
            plot(Robot_Data.robot(i).x(1), Robot_Data.robot(i).y(1), 'kx');
            plot(Robot_Data.robot(i).x(end), Robot_Data.robot(i).y(end), 'ko')
        ...
        ps(length(ps)+1) = plot(SimParams.GoTo_Coords(1),SimParams.GoTo_Coords(2), 'ks','MarkerSize',18);
