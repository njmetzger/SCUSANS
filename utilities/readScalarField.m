function [Z,field_width] = readScalarField(a,b,ScalarFieldSelection)
% <READSCALARFIELD> - Defines scalar field function(s) used in simulations. 
%
% Syntax:  [Z,field_width] = readScalarField(a,b,ScalarFieldSelection)
%
% Inputs:
%    a - x coordinate
%    b - y coordinate 
%    ScalarFieldSelection - Integer ID of desired scalar field. (See below)
%
% Outputs:
%    Z - Scalar field height at a given x-y coordinate. 
%    field_width - Approximate width of scalar field function. 
%
...
% Initialize both outputs to zero
Z=0; 
field_width=0;
