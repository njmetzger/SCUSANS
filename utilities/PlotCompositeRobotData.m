function PlotCompositeRobotData(data)
...
resolution = 500;
PlotScalarField(gca,ScalarFieldSelection,resolution,DesiredValue);
...
title(['\fontsize{15} ', 'Robot Position History', char(10) ...
    ...
    '\fontsize{8} ', sprintf('Number of Robots = %i',N), char(10)],'interpreter','tex');
hold off
end
