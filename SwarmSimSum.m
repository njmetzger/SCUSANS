function [ThetaCommand] = SwarmSimSum(Attract, Disperse, Avoidance, FindMin, FindMax, FindContour, FollowRidge, FollowTrench, FR_beta)
...
Total= (1/100).*Attract + Disperse + Avoidance + FindMin + FindMax + FindContour + FollowRidge + FollowTrench +FR_beta;
