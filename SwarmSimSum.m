function [ThetaCommand] = SwarmSimSum(Attract, Disperse, Avoidance,GoTo, FindMin, FindMax, FindContour)
...
Total= Attract + Disperse + 100*Avoidance +GoTo+ 8*FindMin + 8*FindMax + FindContour;
